...
import com.kylemadsen.testandroid.bluetooth.BluetoothDevicesActivity
...
class MainViewController(
    ...
    override fun attach(view: View) {
        ...
        view.find<View>(R.id.goto_bluetooth_select).setOnClickListener {
            viewRouter.goToActivity(BluetoothDevicesActivity::class.java)
        }
    }
