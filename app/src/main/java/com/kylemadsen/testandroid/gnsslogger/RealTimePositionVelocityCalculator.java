...
package com.kylemadsen.testandroid.gnsslogger;
...
import com.kylemadsen.testandroid.gnsslogger.pseudorange.GpsMathOperations;
import com.kylemadsen.testandroid.gnsslogger.pseudorange.GpsNavigationMessageStore;
import com.kylemadsen.testandroid.gnsslogger.pseudorange.PseudorangePositionVelocityFromRealTimeEvents;
...
public class RealTimePositionVelocityCalculator implements GnssListener {
  ...
  private GnssMainActivity mGnssMainActivity;
  ...
  private ResultFragment.UIResultComponent uiResultComponent;

  public synchronized ResultFragment.UIResultComponent getUiResultComponent() {
    return uiResultComponent;
  }

  public synchronized void setUiResultComponent(ResultFragment.UIResultComponent value) {
  ...
  public void onGnssMeasurementsReceived(final GnssMeasurementsEvent event) {
    ...
    final Runnable r =
        new Runnable() {
          @Override
          public void run() {
            mGnssMainActivity.runOnUiThread(
                new Runnable() {
                  @Override
                  public void run() {
  ...
  private void logText(String tag, String text, int color) {
    ResultFragment.UIResultComponent component = getUiResultComponent();
    if (component != null) {
  ...
  /**
   * Sets {@link GnssMainActivity} for running some UI tasks on UI thread
   */
  public void setMainActivity(GnssMainActivity gnssMainActivity) {
    this.mGnssMainActivity = gnssMainActivity;
  }
