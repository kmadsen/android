...
public class SettingsFragment extends Fragment {
  ...
  /** Set up {@link GnssMainActivity} to receive update from AR result broadcast */
  ...
  public View onCreateView(
    ...
    final View view = inflater.inflate(R.layout.gnss_settings_fragment, container, false /* attachToRoot */);
        ...
        new OnCheckedChangeListener() {
          ...
          public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
            if (isChecked) {
              ...
              View layout = inflater.inflate(R.layout.gnss_pop_up_window,
